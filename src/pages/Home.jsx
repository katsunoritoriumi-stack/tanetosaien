...
const Home = () => {
  ...
  <div className="gallery-info">
    ...
    トマト、茄子、ピーマン、ジャガイモ、スイスチャード・空芯菜などの葉物、サヤインゲン、シシトウ、パプリカ、ニンニク、カボチャ、玉ねぎ、コールラビ、ビーツ、きゅうり、ズッキーニ、サツマイモ、落花生、人参、大根、ヤーコン、キクイモ、きのこ類…他</p>
  </div>
</RevealOnScroll>
            ...
            <RevealOnScroll delay={0.3} className="gallery-item">
              ...
              <div className="gallery-info">
                <h3>無農薬トウモロコシ</h3>
                <p>毎年大好評！自然の旨み豊かなトウモロコシを8月上旬頃から発送します。無農薬栽培の難しさから先端を切り落とした物ばかりになる場合もあります。希に虫が入ってしまうこともありますが、ご了承下さい。</p>
              </div>
            </RevealOnScroll>
        ...
        <div className="container info-container">
          <RevealOnScroll className="info-box">
            ...
            <ul className="info-list">
              ...
              <li>購入方法や詳細は直営ショップページをご覧ください。</li>
            </ul>
            <div className="mt-8">
