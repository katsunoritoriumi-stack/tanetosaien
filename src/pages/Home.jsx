          ...
          <RevealOnScroll className="philosophy-grid">
            <div className="philosophy-text">
              ...
              <div className="philosophy-content">
                ...
                <p>
                  厳しい冬を超えてゆっくりと育ったニンニクと玉ねぎはしっかり乾燥させて保存します。季節の野菜をあれこれ数種類詰め込んで、ご家庭用にも発送しています。一般的なお野菜も勿論ありますが、ちょっと変わった西洋野菜や、色や形の変わったお馴染みの野菜、地方伝統野菜などを多数栽培し販売しています。
                </p>
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="gallery-grid">
            ...
            <RevealOnScroll delay={0.3} className="gallery-item">
              ...
              <div className="gallery-info">
                <h3>朝採りトウモロコシ</h3>
                <p>毎年大好評！あまーいトウモロコシを8月上旬頃から発送します。無農薬栽培の難しさから先端を切り落とした物などが入る場合もあります。</p>
              </div>
            </RevealOnScroll>
            ...
            <RevealOnScroll delay={0.5} className="gallery-item">
              ...
              <div className="gallery-info">
                <h3>ルバーブドレッシング</h3>
                <p>自家菜園のルバーブ、玉ねぎ、バジルを使用。毎年7月頃に販売開始！酸っぱくておいしいノンオイルタイプです。</p>
              </div>
            </RevealOnScroll>
          </div>
        </div>
        ...
        <div className="container info-container">
          <RevealOnScroll className="info-box">
            ...
            <ul className="info-list">
              ...
              <li>トウモロコシの発送開始は8月上旬頃を予定しております。</li>
            </ul>
            <div className="mt-8">
